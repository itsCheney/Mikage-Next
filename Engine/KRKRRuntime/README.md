...
- `krkrsdl3_build` fork submodule: `ce28e4f88c51d3deb230d5333a49531c01319a25` (`itsCheney/krkrsdl3_build`, branch `codex/metal-layer-composition`)
- nested `krkrsdl3` core submodule: `1bd8a2d5e5bb6ab39557ddb2accd1fd4f714c0fc` (`itsCheney/krkrsdl3`, branch `codex/metal-layer-composition`)
